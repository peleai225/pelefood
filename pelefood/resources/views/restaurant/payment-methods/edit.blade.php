...
@section('title', 'Modifier la méthode de paiement - ' . $restaurant->name)
@section('page-title', 'Modifier la méthode de paiement')
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Modifier la méthode de paiement</h1>
                <p class="text-gray-600 mt-1">Modifiez les paramètres de cette méthode de paiement</p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <form method="POST" action="{{ route('restaurant.payment-methods.update', $paymentMethod) }}" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="provider" name="provider" 
                            ...
                            @foreach($providers as $value => $label)
                                <option value="{{ $value }}" {{ old('provider', $paymentMethod->provider) == $value ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="3" 
                                  ...
                                  placeholder="Description optionnelle de cette méthode de paiement">{{ old('description', $paymentMethod->description) }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="number" id="transaction_fee" name="transaction_fee" 
                    ...
                    <div>
                        ...
                        <input type="number" id="fixed_fee" name="fixed_fee" 
                               value="{{ old('fixed_fee', $paymentMethod->fixed_fee) }}" 
                               step="1" min="0"
