...
@section('page-description', 'Créer une nouvelle facture')
...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-400">Créez une nouvelle facture pour un restaurant</p>
        </div>
        ...
        <div class="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-xl p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="invoice_number" name="invoice_number" value="{{ old('invoice_number') }}" class="w-full bg-gray-700 border border-gray-600 text-white rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="FACT-2024-001">
                </div>
            </div>
        </div>
        ...
        <div class="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-xl p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="relative">
                        <input type="number" id="total_amount" name="total_amount" step="0.01" min="0" required value="{{ old('total_amount') }}" class="w-full bg-gray-700 border border-gray-600 text-white rounded-lg px-3 py-2 pl-10 focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="0.00">
                ...
                <div>
                    ...
                    <input type="date" id="due_date" name="due_date" value="{{ old('due_date') }}" class="w-full bg-gray-700 border border-gray-600 text-white rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                </div>
            ...
            <div class="mt-6">
                ...
                <textarea id="description" name="description" rows="3" class="w-full bg-gray-700 border border-gray-600 text-white rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Description de la facture...">{{ old('description') }}</textarea>
            </div>
        </div>
        ...
        <div class="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-xl p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <textarea id="notes" name="notes" rows="3" class="w-full bg-gray-700 border border-gray-600 text-white rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Notes internes...">{{ old('notes') }}</textarea>
                </div>

                <div>
                    <label for="terms_conditions" class="block text-sm font-medium text-gray-300 mb-2">Conditions</label>
                    <textarea id="terms_conditions" name="terms_conditions" rows="3" class="w-full bg-gray-700 border border-gray-600 text-white rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Conditions de paiement...">{{ old('terms_conditions') }}</textarea>
                </div>
            </div>
        </div>
