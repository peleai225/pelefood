...
@section('page-description', 'Modifier les informations du tenant')
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Modifier le Tenant</h1>
                    <p class="text-gray-600">Modifier les informations de {{ $tenant->name }}</p>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea id="address" 
                                  ...
                                  placeholder="Adresse complète">{{ old('address', $tenant->address) }}</textarea>
                        @error('address')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
