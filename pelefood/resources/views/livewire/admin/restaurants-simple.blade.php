<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Gestion des Restaurants (Test Simple)</h1>
            <p class="text-gray-600 mt-2">Version simplifiée pour tester les modals</p>
        </div>
