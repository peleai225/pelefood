            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="address" 
                              name="address" 
                              rows="3"
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors">{{ old('address', $user->address) }}</textarea>
                    @error('address')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-gray-50 rounded-lg p-6 space-y-4">
                    ...
                    <div class="text-sm text-gray-600">
                        ...
                        Ces informations sont gérées par le propriétaire du restaurant.
                    </div>
                </div>
            </div>
