                ...
                <div class="flex items-center gap-x-4">
                    ...
                    @include('admin.partials.notification-dropdown')
                        ...
                        <div x-show="open" @click.away="open = false" 
                            ...
                            <div class="py-1">
                                <a href="{{ route('admin.dashboard') }}" class="flex items-center px-4 py-2 text-sm text-popover-foreground hover:bg-accent">
                                    <i data-lucide="home" class="w-4 h-4 mr-3"></i>
                                    Dashboard
                                </a>
                                <a href="{{ route('admin.users.index') }}" class="flex items-center px-4 py-2 text-sm text-popover-foreground hover:bg-accent">
